...
function CheckNull(strElem,strName)
{
	...
	{
		window.alert(strName + " 必ず入力してください");
...
function CheckMustNum(strElem,strName)
{
	...
	{
		window.alert(strName + " 数字を入力してください");
		document.getElementById(strElem).focus();
		return false;
	}
	return true;
...
function CheckNumber(strElem,strName)
{
	...
	for(var i=0;i<str.length;i++)
	{
		...
		{
			window.alert(strName + " 整数を入力してください");
			document.getElementById(strElem).focus();
			return false;
		}
	}
...
function CheckChinese(strElem,strName)
{
	...
	for(var i=0;i<str.length;i++)
	{
		...
		{
			window.alert(strName + " 文字を入力してください");
			document.getElementById(strElem).focus();
			return false;
		}
	}
...
function CheckEC(strElem,strName)
{
	...
	for(var i=0;i<str.length;i++)
	{
		...
		{
			window.alert(strName + " 文字または英文字を入力してください");
			document.getElementById(strElem).focus();
			return false;
		}
	}
...
function CheckEmail(strElem,strName)
{
	...
	{
		window.alert("正しい " + strName　+"を入力してください");
		document.getElementById(strElem).focus();
		return false;
	}
	return true;
...
function CheckMustDate(strElem,strName)
{
	...
	{
		window.alert(strName + " 日時を入力してください,例:1900-01-01");
		document.getElementById(strElem).focus();
		return false
	}
}
