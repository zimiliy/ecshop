...
<body class="main">
	...
	<div id="box_autoplay">
    	<div class="list">
        	<ul>
            	<li><img src="${pageContext.request.contextPath }/resources/client/ad/cm1.jpg" width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }/resources/client/ad/cm2.jpg" width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }/resources/client/ad/cm3.jpg" width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }/resources/client/ad/cm4.jpg" width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }/resources/client/ad/cm5.jpg" width="900" height="335" /></li>
        	</ul>
    	</div>
	</div>
	<!-- 商场首页轮播图  end -->
            ...
            <tr>
                <c:forEach items="${products}" var="p" varStatus="vs">
                    <td>
                        ...
                        <div class="remark">
                            <a href="${pageContext.request.contextPath}/QueryProductByIdServlet?id=${p.id}">商品名： ${p.name}<br />価格：￥${p.price} </a>
                        </div>
                    </td>
                </c:forEach>
            </tr>
