			...
			<tr>
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath }/ToClientIndexServlet">首页</a>
						   &nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath}/AddCartServlet">&nbsp;购物车</a>
						   &nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;订单
					</div>
						...
						<table cellspacing="0" class="infocontent">
							<tr>
								...
								<table width="100%" border="0" cellspacing="0">
										<tr>
											<td>
												<p>你好，${user.username}！欢迎您来到缘起商城结算中心</p>
											</td>
										</tr>
										<tr>
											<td>
												...
												<p>
												    ...
												    &nbsp;&nbsp;&nbsp;&nbsp;
													<br/> 
													联系方式：<input type="text" id="receiverPhone" name="receiverPhone" value="${user.iphone}" style="width:150px" onkeyup="checkReceiverPhone();" />
